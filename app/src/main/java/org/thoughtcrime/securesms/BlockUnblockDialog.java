...
public final class BlockUnblockDialog {
                                                   ...
                                                   @Nullable Runnable onBlockAndReportSpam)
  {
    ...
    if (recipient.isGroup()) {
      if (SignalDatabase.groups().isActive(recipient.requireGroupId())) {
        builder.setTitle(resources.getString(R.string.BlockUnblockDialog_block_and_leave_s, recipient.getShortDisplayName(context)));
        ...
        builder.setTitle(resources.getString(R.string.BlockUnblockDialog_block_s, recipient.getShortDisplayName(context)));
                                                     ...
                                                     @NonNull Runnable onUnblock)
  {
    ...
    if (recipient.isGroup()) {
      if (SignalDatabase.groups().isActive(recipient.requireGroupId())) {
        builder.setTitle(resources.getString(R.string.BlockUnblockDialog_unblock_s, recipient.getShortDisplayName(context)));
